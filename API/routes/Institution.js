...
router.post('/', async (req, res) => {
    ...
    const { institutionName, institutionType, onboardingGrade, province, address, email, contactNumber } = req.body;
    ...
    try {
        ...
        const newInstitution = new Institution({ institutionName, institutionType, onboardingGrade, province, address, email, contactNumber });
